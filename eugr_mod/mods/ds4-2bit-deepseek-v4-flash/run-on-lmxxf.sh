...
new2 = (
    ...
    '                        # by an upstream WeightsMapper; try both forms.\n'
    '                        target = None\n'
    ...
    '                                _matches = [k for k in params_dict.keys() if "iq2xxs" in k or "q2k" in k][:3]\n'
    '                                print(f"[DS4_FT_DBG] no match for {name!r}; sample params_dict keys w/ iq2xxs|q2k: {_matches}", flush=True)\n'
    '                        continue\n'
